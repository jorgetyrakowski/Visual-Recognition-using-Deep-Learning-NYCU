...
class TrainDataset(Dataset):
    ...
    def __init__(self, data_dir, transform=None, is_valid=False):
        ...
        # Map folder names to class indices (ensure correct numerical mapping)
        self.class_to_idx = {
...
# Print class mapping for verification
        if not is_valid:
            ...
            for i, (class_name, idx) in enumerate(
                ...
                if i < 10:  # Only print first 10 to avoid cluttering console
    ...
    def get_class_distribution(self):
        """Return dictionary with count of samples per class."""
        class_counts = {}
...
class TestDataset(Dataset):
    ...
    def __init__(self, image_folder, transform=None):
        ...
        # Get all image files and sort them for consistent results
        self.image_files = [
    ...
    def __getitem__(self, idx):
        ...
        # Return filename without extension for prediction CSV
...
def get_transforms(is_train=True):
    """
    Returns transformation pipelines for train and validation/test

    Args:
        is_train: Whether to return transforms for training or validation/test
